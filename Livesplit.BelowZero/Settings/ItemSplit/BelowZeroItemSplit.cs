...
{
    public partial class BelowZeroItemSplit : BelowZeroSplitSetting
    {        
        ...
        public BelowZeroItemSplit() : this(new ItemSplit(InventoryItem.None, onlySplitOnce: true, isSubCondition: false)) { }
        public BelowZeroItemSplit(ItemSplit split)
        {
            InitializeComponent();
        ...
        {
            var splitSettings = new BelowZeroItemSplitSettings(_split);
    ...
    public class ItemSplit : BelowZeroSplit
    {
