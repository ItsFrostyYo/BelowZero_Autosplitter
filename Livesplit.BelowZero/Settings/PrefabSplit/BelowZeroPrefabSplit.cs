...
namespace LiveSplit.BelowZero
{
    ...
    public partial class BelowZeroPrefabSplit : BelowZeroSplitSetting
    {
        ...
        public BelowZeroPrefabSplit() : this(new PrefabSplit(SplitName.None, onlySplitOnce: true, isSubCondition: false)) { }
        public BelowZeroPrefabSplit(PrefabSplit prefabSplit)
        {
            InitializeComponent();
        ...
        {
            var splitSettings = new BelowZeroPrefabSplitSettings(_split);
    ...
    public class PrefabSplit : BelowZeroSplit
    {
