...
{
    public partial class BelowZeroBiomeSplit : BelowZeroSplitSetting
    {
        ...
        public BelowZeroBiomeSplit() : this(new BiomeSplit((Biome.None, Biome.None), onlySplitOnce: true, isSubCondition: false)) { }
        public BelowZeroBiomeSplit(BiomeSplit biomeSplit)
        {
            InitializeComponent();
        ...
        {
            var splitSettings = new BelowZeroBiomeSplitSettings(_split);
    ...
    public class BiomeSplit : BelowZeroSplit
    {
