...
{
    public partial class BelowZeroBlueprintSplitSettings : BelowZeroBaseSettings
    {
        ...
        public BelowZeroBlueprintSplitSettings(BlueprintSplit split)
        {
            InitializeComponent();
            ...
            if (split.IsSubCondition || BelowZeroSettings.OrderedLiveSplit || BelowZeroSettings.OrderedAutoSplits)
