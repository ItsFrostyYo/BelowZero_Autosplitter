...
{
    public partial class BelowZeroBlueprintSplit : BelowZeroSplitSetting
    {
        ...
        public BelowZeroBlueprintSplit() : this(new BlueprintSplit(Unlockable.None, onlySplitOnce: true, isSubCondition: false)) { }
        public BelowZeroBlueprintSplit(BlueprintSplit blueprintSplit)
        {
            InitializeComponent();
        ...
        {
            var splitSettings = new BelowZeroBlueprintSplitSettings(_split);
    ...
    public class BlueprintSplit : BelowZeroSplit
    {
