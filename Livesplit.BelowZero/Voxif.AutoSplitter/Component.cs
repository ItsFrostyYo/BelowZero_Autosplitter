...
namespace Voxif.AutoSplitter {
    public abstract class Component : LogicComponent {
        ...
        protected BelowZeroSettings settings;
        ...
        public Component(LiveSplitState state) {
            ...
            if(GameTimeType != EGameTime.None) {
                ...
                if(IsGameTimeDefault && state.CurrentTimingMethod == TimingMethod.RealTime) {
                    string gameName = LiveSplit.BelowZero.Factory.ExAssembly.Description().Substring(17);
        ...
        public override string ComponentName => LiveSplit.BelowZero.Factory.ExAssembly.FullComponentName();
        ...
        public override void Update(IInvalidator invalidator, LiveSplitState state, float width, float height, LayoutMode mode) {         
            ...
            if(timer.CurrentState.CurrentSplitIndex < 0) {
                if(settings.StartEnabled && Start()) {
                    timer.Start();
                    logger?.Log("Start");
                }
            }
